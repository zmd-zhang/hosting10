...
async function handleRequest(request) {
  try {
    // Lazy load cryptographic functions inside the request handler
    const cryptoFunctions = getCryptoFunctions();

    // Example usage of coreSalsa20
    ...
    cryptoFunctions.coreSalsa20(output, input, constants);
...
function getCryptoFunctions() {
  // Utility Functions (moved inside)
  ...
  return { coreSalsa20 }; // Return the crypto functions
}
